...
HD_PWD='D:/Give_me_Attention/Give_me_Attention.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log phase_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source phase_2.tcl -notrace
