...
HD_PWD='D:/Give_me_Attention/Give_me_Attention.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log phase_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source phase_2.tcl
