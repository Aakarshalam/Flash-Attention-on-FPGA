...
#
# Script generated by Vivado on Wed Jun 11 11:04:11 +0530 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Aakarsh_Files/Flash-Attention-on-FPGA/Give_me_Attention.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
